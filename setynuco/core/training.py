...
def get_models_properties(model, update_progress_func):
    ...
    for idx, class_uri in enumerate(classes_uris):
        ...
        properties = easysparql.get_properties_for_class_abox(endpoint=model.knowledge_graph,
                                                              ...
                                                              raiseexception=True, min_num=30)
...
def train_abox(model, min_num_of_objects):
    try:
        ...
        clusters_features_pair_list = compute_features_from_endpoint(model=model,
                                                                     class_property_uris=classes_properties_dict,
